 ...
 */
final class Version20240203045630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT NOT NULL, ability_id INT DEFAULT NULL, name VARCHAR(20) NOT NULL, image VARCHAR(30) DEFAULT NULL, sort INT DEFAULT NULL, shape VARCHAR(10) NOT NULL, location VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
